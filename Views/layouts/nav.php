				...
				<div class="header-column">
					<div class="header-row">
						<div class="header-logo header-logo-sticky-change" style="width: 82px; height: 40px;">
							<a href="<?= WEB_URL ?>">
							<?= create_tag_element('img', ['src'=>IMAGES_URL.'logo-full-64x.png', 'class'=>'header-logo-non-sticky opacity-0', 'alt'=>'', 'height'=>'40'], false); ?>
							<?= create_tag_element('img', ['src'=>IMAGES_URL.'logo-small.png', 'class'=>'header-logo-sticky opacity-0', 'alt'=>'', 'height'=>'40'], false); ?>
							</a>
						</div>
					</div>
				</div>
